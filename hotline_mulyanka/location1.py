...
dialog = [
    pygame.image.load('./data/textures/dialog/zhitel.png'),
    pygame.image.load('./data/textures/dialog/lungin.png'),
    pygame.image.load('./data/textures/dialog/malgin.png'),
]
location1 = [
...
mishamonolog = pygame.transform.scale(dialog[2], (400, 400))
...
dialogszhitel = pygame.transform.scale(dialog[0], (500,500))
...
text4 = myfont.render('Нажмите пробел чтобы продолжить',False,(0,0,0))
text5 = myfont.render('Малыгин это просто кошмар', False, (0,0,0))
text6 = myfont.render('Помогите, тут малыгин снова был', False, (0,0,0))
text7 = myfont.render('ЭТО МАЛЫГИИИИН', False, (0,0,0))
text8 = myfont.render('что же это за дом?',False,(0,0,0))
def monolog():
    screen.blit(text8, (500,1000))
    screen.blit(mishamonolog, (500, 600))
def dialogwithpolice():
    screen.blit(text1, (1000,150))
    screen.blit(text2, (900,250))
    screen.blit(text3, (500,900))
    screen.blit(text4, (500,1000))
    screen.blit(dialogszhitel,(1000,500))
def dialog1():
    screen.blit(dialogszhitel,(1000,500))
    screen.blit(text5, (500,1000))
def dialog2():
    screen.blit(dialogszhitel,(1000,500))
    screen.blit(text6, (500,1000))
def dialog3():
    screen.blit(dialogszhitel,(1000,500))
    screen.blit(text7, (500,1000))
while running:
